...
# Frame 1
main_frame = Frame(root, bg="black", width=540,height=540)
main_frame.pack()
...
buy_frame = Frame(main_frame, width=360, height=180, bg=background_color) 
buy_frame.grid()
...
# converter Main Screen GUI...
sell_frame = Frame(main_frame, width=360, height=180, bg=sell_background_color) 
sell_frame.grid()
...
# converter Main Screen GUI...
stock_frame = Frame(main_frame, width=360, bg=sell_background_color,) 
stock_frame.grid(row=2, column=0, side=RIGHT)
